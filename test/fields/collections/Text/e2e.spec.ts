...
import type { PayloadTestSDK } from 'utils/helpers/sdk/index.js'
import type { Config } from 'utils/payload-types.js'
...
import { reInitializeDB } from 'utils/helpers/reInitializeDB.js'
import { RESTClient } from 'utils/helpers/rest.js'
import { TEST_TIMEOUT_LONG } from 'playwright.config.js'

import { textDoc } from './shared.js'
import { wait } from 'payload/utilities'
import { usersSlug } from 'utils/slugs.js'
...
describe('Text', () => {
  beforeAll(async ({ browser }, testInfo) => {
    ...
    url = new AdminUrlUtil(serverURL, usersSlug)
    ...
    console.log('🚀 ~ beforeAll ~ page:', page)
  })
  beforeEach(async () => {
    await reInitializeDB({
      serverURL,
